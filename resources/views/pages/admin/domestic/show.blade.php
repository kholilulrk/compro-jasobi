        ...
        <div class="animated fadeIn">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-edit"></i> Show Domestic
                </div>
                <div class="card-body">
                    <div class="form-group" id="title">
                        ...
                        <div class="controls">
                            <input class="form-control" id="title" size="16" type="text" name="title"
                                placeholder="Company Video Profile" value="{{ $domestics->title }}" readonly>
                        </div>
                    </div>
                    <div class="form-group" id="short_description">
                        ...
                        <div class="controls">
                            <input class="form-control" id="short_description" size="16" type="text" name="short_description"
                                placeholder="Company Video Profile" value="{{ $domestics->short_description }}" readonly>
                        </div>
                    </div>
                    <div class="form-group" id="description">
                        <label class="col-form-label" for="description">Description</label>
                        <div class="controls">
                            <input class="form-control" id="url" size="16" type="text" name="description"
                                placeholder="Company Video Profile" value="{{ strip_tags($domestics->description) }}" readonly>
                        </div>
                    </div>
                    <div class="form-group" id="url-video">
                        ...
                        <div class="controls">
                            <input class="form-control" id="url" size="16" type="text" name="url"
                                placeholder="Company Video Profile" value="{{ $domestics->url }}" readonly>
                        </div>
                    </div>
                    <div class="form-group" id="url_website">
                        ...
                        <div class="controls">
                            <input class="form-control" id="url_website" size="16" type="text" name="url_website"
                                placeholder="Company Video Profile" value="{{ $domestics->url_website }}" readonly>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <a href=" {{ route('admin.domestic.index') }} " type="submit" class="btn btn-success">Back</a>
                </div>
            </div>
        </div>
    </div>
