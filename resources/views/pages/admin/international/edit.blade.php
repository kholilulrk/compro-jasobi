...
<div id="ui-view">
    <div>
        ...
        @section('breadcrumb')
        <li class="breadcrumb-item"><a href=" {{ route('admin.international.index') }} "> International </a></li>
        ...
        <div class="animated fadeIn">
            ...
            <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('admin.international.update', $internationals->id) }}"
                    method="post" enctype="multipart/form-data">
                    {{ method_field('put') }}
                    {{ csrf_field() }}
                    <div class="card-header">
                        <i class="fa fa-edit"></i> Edit International
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="title" size="16" type="text" name="title"
                                    placeholder="Website Title" value=" {{ $internationals->title }} " required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id="url-video">
                            ...
                            <div class="controls">
                                <input class="form-control" id="url" size="16" type="text" name="url"
                                    placeholder="Company Video Profile" value="{{ $internationals->url }}">
                        ...
                        <div class="form-group" id="url-website">
                            ...
                            <div class="controls">
                                <input class="form-control" id="url" size="16" type="text" name="url_website"
                                    placeholder="Company Video Profile" value="{{ $internationals->url_website }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.international.index') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    quill.root.innerHTML = '{!! $internationals->description !!}';
