                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-striped table-bordered datatable dataTable no-footer"
                                    ...
                                    <tbody>
                                        @foreach ($data_feature as $key => $feature)
                                    <tr role="row" class="odd">
                                        <td> {{ $key+1 }} </td>
                                        <td>
                                            <div class="thumbnail">
                                                <img class="img-thumbnail" src="{{ asset($feature->showImage()) }}"
                                                    alt="">
                                            </div>
                                            <span class="text-muted">Publish : {{ $feature->created_at }}</span>
                                        </td>
                                        <td class="sorting_1"> <b>{{ $feature->title }}</b> </td>
                                        ...
                                        <td>
                                            <form action=" {{ route('admin.feature.update', $feature->id) }} "
                                                ...
                                                @csrf
                                                @method('delete')
                                                <a href=" {{ route('admin.feature.show', $feature->id) }} "
                                                ...
                                                <form action="{{ route('admin.feature.destroy', $feature->id) }}"
                                                    method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
                                                    <button class="btn btn-danger"
