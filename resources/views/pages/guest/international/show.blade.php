                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="menu-bar">
                                        <ul class="menu-links">
                                            ...
                                            <li><a href="javascript:void(0)"> Internatioanal Partners</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
page-title -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="js-video [youtube, widescreen]">
                            <iframe width="560" height="315" src="{{$internationals->showVideo()}}" frameborder="0"
                        ...
                        <div class="section-title mb-20">
                            ...
                            <div class="clearfix">
                                <div class="title float-left mb-20">
                                    <h2 class="theme-color">{{ $internationals->title }}</h2>
                                    {{-- <span>Web design</span> --}}
                                    <p class="text-white"> {{ $internationals->short_description }} </p>
                                </div>
                                
                            </div>
                        <a class="button mt-20" href=" {{ $internationals->url_website }} ">Kunjungi Website Kami</a>
                    </div>
                </div>
            </div>
        </section>
 ...
 About-->
        ...
        <section class="page-section-ptb bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}'
            style="background-image:url({{asset($internationals->showImage())}}">
            <div class=" container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center pt-30 pb-30">
                        <h2 class="mb-20 text-white"> {{ $internationals->title }} International Partners</h2>
                        <span class="theme-color">- {{ $internationals->title }} -</span>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center">
                            ...
                            <p> {!! $internationals->description !!} </p>
                        </div>
                    </div>
                </div>
